    ...
    if (userAuthenticated()) {
      ...
      try {
        ...
        if (err.response.status === 400) {
          // TODO: Implement PopUp for authFailed
          setAuthFailed(true);
        } else if ((err.response.status === 500) & (userId === "")) {
          // TODO: Implement PopUp for authFailed
          setAuthFailed(true);
        }
      }
    ...
    <div className="create-post-container">
      ...
      <form>
        ...
        >
          <option
            key="00"
            disabled={touchedFields.activity}
            value={undefined}
            label="Activity"
          ></option>
      ...
      {authFailed ? (
        <form className="auth-failed-form">
          <label className="auth-failed-label" htmlFor="auth-failed-submit">
            Your session has ended, please re-authenticate:{" "}
          </label>
          <input
